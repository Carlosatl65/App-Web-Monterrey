var url = "BD/Administrador/ordenBuses.php"; /* Ruta de archivo php */
var Inventario = new Vue({
    ...
    methods:{
        ...
        //Listar unicamente los buses
        listar:function(){
            axios.post(url, {opcion:"listar"}).then(response =>{
                this.listBuses = response.data;
            });
        },        
        ...
        aceptarCambios: function() {
            ...
            axios.post(url, {
                ...
                Swal.fire({
                    ...
                    text: "El nuevo orden de buses se guardó exitosamente",
                    icon: "success"
                });
            });
