            ...
            <div class="row flex-nowrap"> <!-- Inicio de fila -->
                <div class="sidebar"> <!-- Menú lateral para vista en ordenador y dispositivos con pantallas anchas -->
                    <div class="user-info"> <!-- Información de usuario, foto y nombre -->
                        ...
                        <a href="usuarioSocio" class="btn btn-primary btn-sm" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Perfil"><i class="bi bi-person-circle"></i></a> <!-- Botón para ver perfil de usuario -->
                    ...
                    <nav class="nav flex-column flex-grow-1"> <!-- Links a diferentes páginas del sistema -->
                        <a class="nav-link active" href="inicioSocio"><i class="fs-4 bi-house"></i> Inicio</a>
                        <a class="nav-link active" href="miBus"><i class="fs-4 bi-bus-front"></i> Mi Bus</a>
                ...
                <div class="bottom-nav"> <!-- Menú inferior para vista de moviles -->
                    <a href="inicioSocio" class="nav-link">
                        <i class="fs-4 bi-house"></i><br>
                        <label class="form-label">Inicio</label>
                    </a>
                    <a href="miBus" class="nav-link">
                        <i class="fs-4 bi-bus-front"></i><br>
                        <label class="form-label">Mi Bus</label>
                    </a>
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="bottomNavDropdown3">
                            <li><a class="dropdown-item" href="usuarioSocio">Perfil</a></li>
