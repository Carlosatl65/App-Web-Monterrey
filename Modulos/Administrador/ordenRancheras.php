...
<div id="Lista"> <!-- Contenedor con id nombrada en Vue -->
    <div class="container">
        <br>
            ...
            <h1 class="text-center fw-bolder">Orden de Asignación de Rutas para Rancheras</h1>
            <br><br>
            ...
            <!-- Listado de Rancheras en el orden establecido -->
            <div class="row mt-3 justify-content-center">
                <div class="col-lg-4">
                    <ul class="list-group" id="lista-buses-reorganizable">
                        <li class="list-group-item text-center tarea" v-for="dato of listRancheras" v-bind:data-id="dato.idBus">{{dato.infoBuses}}</li>
                    </ul>
                </div>
            </div><br><br>
...
?>
    ...
    <script src="Modulos JS/Administrador/ordenRancheras.js"></script>
