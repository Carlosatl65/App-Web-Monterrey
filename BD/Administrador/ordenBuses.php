...
switch($opcion){
    ...
    case "ordenLista":
        ...
        /* Mandar al App_LOG */
        $log_consulta = "INSERT INTO `app_log`(`idUsuario`, `descripcion`, `fechaHoraAccion`) VALUES (:idUsuario,'Se ha cambiado el orden de los buses',:fechaAccion)";
